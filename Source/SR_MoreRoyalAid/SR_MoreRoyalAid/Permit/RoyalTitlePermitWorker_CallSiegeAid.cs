...
{
    public class RoyalTitlePermitWorker_CallSiegeAid : RoyalTitlePermitWorker_CallResourceAidBase
    {
        /// <summary>
        /// 呼叫支援
        /// </summary>
        ...
        protected override void CallAid(Pawn caller, Faction faction, Map map, bool isFree)
        {
            ...
            if (Incident.IncidentDefOf.CallSiegeAid.Worker.TryExecute(incidentParms))
            {
                if (!isFree)
                {
        ...
        {
            return "SR_CommandCallRoyalSiegeAidFreeOption".Translate();
        }
        /// <summary>
        /// 获取皇家援助文本(消耗声望)
        /// </summary>
        ...
        {
            return "SR_CommandCallRoyalSiegeAidFavorOption".Translate(ticksToDays.ToString("0.0"), favorCost, factionName);
        }
    }
}
